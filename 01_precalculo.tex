...
\begin{definition}[Números reales] \label{numeros_reales} \index{Conjunto!Números reales}
...
\begin{definition}[Intervalo] \index{Conjunto!Números reales!Intervalo} \label{intervalo}
...
\begin{observation}[Clasif. intervalos]
