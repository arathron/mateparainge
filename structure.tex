...
\usepackage[english, spanish, activeacute]{babel} % Spanish language/hyphenation
...
\definecolor{ocre}{RGB}{120,209,209} % lo cambio por celeste
...
\newtheorem{observation}[dummy]{Observación}
\newtheorem{property}[dummy]{Propiedad}
